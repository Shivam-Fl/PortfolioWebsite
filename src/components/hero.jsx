      ...
      <div className="flex flex-col-reverse sm:flex-row  content-center items-center font-bold w-[80vw] m-auto mt-[1.5%] sm:mt-[6%] ">
        <div className="justify-self-start  basis-2/3 flex flex-col gap-y-8 sm:gap-y-16 ">
          <div className="relative z-0">
            ...
            <h1 className=" text-2xl  md:text-4xl lg:text-7xl font-outfit"  >
              Hi, I&apos;m{" "}
            ...
            <h4 className=" text-xl md:text-2xl lg:text-6xl font-outfit font-normal">Web developer</h4>
          </div>

          <p className="text-sm sm:text-lg lg:text-3xl text-[#FFFFFFB2] font-outfit text-justify ">
